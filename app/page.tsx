...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link href="/auth/login" asChild>
              <Button variant="ghost" className="text-blue-600 font-semibold hover:text-blue-800 text-sm sm:text-base px-3 sm:px-4 h-8 sm:h-auto">
                Sign In
              </Button>
            </Link>
            <Link href="/report" asChild>
              <Button className="bg-blue-600 hover:bg-blue-700 shadow-lg text-base sm:text-lg px-4 sm:px-8 h-10 sm:h-auto font-semibold transition-transform hover:scale-105 whitespace-nowrap">
                Report Issue
              </Button>
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <section className="py-16 sm:py-24 bg-gradient-to-r from-blue-100 to-blue-200 text-center">
      ...
      {/* Stats Section */}
      <section className="py-12 sm:py-20 bg-white shadow-inner">
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-4 gap-8 sm:gap-12">
          {[
            { icon: <Users className="w-8 h-8 sm:w-10 sm:h-10 text-blue-600" />, value: "2,847", label: "Active Citizens", bgColor: "bg-blue-100" },
            { icon: <CheckCircle className="w-8 h-8 sm:w-10 sm:h-10 text-green-600" />, value: "1,523", label: "Issues Resolved", bgColor: "bg-green-100" },
            { icon: <Clock className="w-8 h-8 sm:w-10 sm:h-10 text-orange-600" />, value: "3.2", label: "Days Avg Response", bgColor: "bg-orange-100" },
            { icon: <AlertTriangle className="w-8 h-8 sm:w-10 sm:h-10 text-red-600" />, value: "89", label: "Open Issues", bgColor: "bg-red-100" },
          ].map(({ icon, value, label, bgColor }) => (
            <div
              key={label}
              className="text-center p-4 sm:p-6 rounded-xl shadow-lg bg-white hover:shadow-2xl transition-shadow cursor-default"
            >
              <div className={`w-16 h-16 sm:w-20 sm:h-20 ${bgColor} rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-5`}>
                {icon}
              </div>
      ...
      {/* How It Works */}
      <section className="py-12 sm:py-20 bg-gradient-to-tr from-white to-blue-50">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-10">
            {[
              ...
              <Card
                key={step}
                className="text-center border-0 shadow-xl hover:shadow-2xl transition-shadow duration-300 cursor-pointer"
              >
                <CardHeader>
                  <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-5 text-white font-extrabold text-lg sm:text-xl shadow-md">
                    {step}
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div>
            ...
            <div className="space-y-2 sm:space-y-3">
              <Link href="/report" className="block text-slate-400 hover:text-white transition-colors font-medium text-sm sm:text-base">
                Report Issue
              </Link>
              <Link href="/issues" className="block text-slate-400 hover:text-white transition-colors font-medium text-sm sm:text-base">
                View Issues
              </Link>
              <Link href="/auth/login" className="block text-slate-400 hover:text-white transition-colors font-medium text-sm sm:text-base">
                Sign In
              </Link>
            </div>
          </div>
